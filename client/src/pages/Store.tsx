  ...
  useEffect(() => {
    async function fetchProducts() {
      const data = await fetch(
        `/api/products/product?sort=${sort.sort},${sort.order}&page=${page}&search=${search}&category=${category.toString()}&brand=${brand.toString()}&price=${price}`,
        {
          method: "GET",
        }
      );
          ...
          <div className="flex-grow">
            <div className="flex justify-between items-center py-4 mb-4">
              ...
              <div className="flex gap-2 items-center">
                ...
                <select
                  value={sort.sort}
                  className="bg-gray-200 px-8 py-2"
                  onChange={(e) => {
            ...
            <div className="flex  justify-between ">
              <div className="flex gap-4 items-center">
                ...
                <button
                  className="bg-white border border-black px-6 py-3"
